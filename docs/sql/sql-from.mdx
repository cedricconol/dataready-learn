...
A table alias shortens the table name within the query. This is especially useful when joining multiple tables (covered in the [JOIN lesson](./sql-join)). Aliasing is covered in full in the [AS lesson](./sql-as).
