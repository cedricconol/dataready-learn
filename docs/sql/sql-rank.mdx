...
### Example 3: NTILE: divide into buckets

`NTILE(n)` assigns each row to one of `n` equal-sized buckets.
...
This splits orders into 4 revenue quartiles (Q1 = lowest, Q4 = highest).
