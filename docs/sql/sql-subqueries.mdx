...
:::tip Prior lesson
Subqueries are closely related to [WITH (CTEs)](./sql-with-cte), which are often a more readable alternative. The sample dataset is defined in the [Introduction to SQL](./intro-to-sql) lesson.
:::
